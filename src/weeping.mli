...
val op_map : ('a -> 'b) -> 'a option -> 'b option
val prop_kind : string -> 'a kind -> 'a kind
val path_kind : string list -> 'a kind -> 'a kind
val select : 'a kind -> Js.Json.t -> 'a option
val prop : string -> 'a kind -> Js.Json.t -> 'a option
val path : string list -> 'a kind -> Js.Json.t -> 'a option
val listify : 'a kind -> 'a list kind
val list_kind : (Js.Json.t -> 'a option) -> 'a list kind
...
val select_tuple3 :
  'a kind * 'b kind * 'c kind -> Js.Json.t -> ('a * 'b * 'c) option
module SelectorOperator :
sig
